...
public class SchoolSportsListFragment extends ListFragment {
	//Hosting activity MUST implement Callbacks
		...
		// Progress Dialog     
				...
				ArrayList<HashMap<String, String>> schoolSportList;
				// url to get all departments list
				private static String url_all_school_sports = "http://146.187.135.49/uknoewu/sports/getallschoolsports.php"; 
				// JSON Node names          
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			schoolSportList = new ArrayList<HashMap<String, String>>();
			// Loading departments in Background Thread
			new LoadSchoolSports().execute();
		}
		 ...
		 **/    
		class LoadSchoolSports extends AsyncTask<String, String, String> {           
			...
			protected void onPreExecute() {             
				 ...
				 pDialog.setMessage("Loading School Sports..");             
			...
			protected String doInBackground(String... args) {   
				...
				//nameValuePairs.add(new BasicNameValuePair("SsID", dbArg));
				try{
					HttpClient httpclient = new DefaultHttpClient();
					HttpPost httppost = new HttpPost(url_all_school_sports);

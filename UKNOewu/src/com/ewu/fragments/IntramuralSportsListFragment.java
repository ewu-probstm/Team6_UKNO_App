...
public class IntramuralSportsListFragment extends ListFragment {
	//Hosting activity MUST implement Callbacks
		...
		// Progress Dialog     
				...
				private static String url_all_intramural_sports = "http://146.187.135.49/uknoewu/sports/getallintramuralsports.php";  
				// JSON Node names          
		...
		class LoadAllTeachers extends AsyncTask<String, String, String> {           
			...
			protected void onPreExecute() {             
				 ...
				 pDialog.setMessage("Loading Intramurals...");             
			...
			protected String doInBackground(String... args) {   
				...
				//nameValuePairs.add(new BasicNameValuePair("IsID", dbArg));
				try{
					HttpClient httpclient = new DefaultHttpClient();
					HttpPost httppost = new HttpPost(url_all_intramural_sports);

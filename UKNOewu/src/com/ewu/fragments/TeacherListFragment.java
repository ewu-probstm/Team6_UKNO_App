...
public class TeacherListFragment extends ListFragment {
	...
	// Progress Dialog     
			...
			private static String url_teachers_by_dept = "http://146.187.135.49/uknoewu/teachers/getteachersbydept.php";  
			// JSON Node names          
			public static final String TAG_LINK = "info_url";     
	...
	class LoadAllTeachers extends AsyncTask<String, String, String> {           
		...
		protected void onPreExecute() {             
			 ...
			 pDialog.setMessage("Loading Teachers. Please wait...");             
		...
		protected String doInBackground(String... args) {   
			...
			nameValuePairs.add(new BasicNameValuePair("DeptID", dbArg));
			try{

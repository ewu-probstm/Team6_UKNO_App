...
public class DepartmentListFragment extends ListFragment {
	...
	private static final String TAG = "FragmentDepartmentList";
	...
	private static String url_all_departments = "http://146.187.135.49/uknoewu/teachers/getalldepartments.php";
	// JSON Node names
	private static final String TAG_DBARG = "DeptID";
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		String deptId = ((TextView) v.findViewById(R.id.deptID)).getText()
				.toString();
		
		Intent i = getActivity().getIntent();
		i.putExtra(TAG_DBARG, deptId);
		
		Fragment newFragment = new TeacherListFragment();
			...
			try{
				jArray = new JSONArray(result);
					...
					for (int i = 0; i < jArray.length(); i++) {                         
						...
						String deptId = c.getString(TAG_DBARG);                           
